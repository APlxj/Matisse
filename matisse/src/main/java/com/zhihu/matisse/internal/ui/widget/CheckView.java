...
public class CheckView extends View {
    ...
    private static final int CONTENT_SIZE = 24; // dp
    ...
    private void init(Context context) {
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.bg_check, context.getTheme());

        mUnCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.bg_uncheck, context.getTheme());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mUnCheckDrawable.setBounds(getCheckRect());
